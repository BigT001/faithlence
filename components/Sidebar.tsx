...
export function Sidebar({ onNewChat, onSelectHistory }: SidebarProps) {
    ...
    return (
        <div
            className={cn(
                "h-screen bg-[#0d0d0d] text-white border-r border-gray-800 transition-all duration-300 flex flex-col",
                collapsed ? "w-16" : "w-64"
            )}
        >
            {/* Header */}
